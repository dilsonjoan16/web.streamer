<template>
  <div id="app">
    <!--<div id="nav">
      ...
      <router-link to="/movies">Mejor valorada</router-link> |
      <router-link to="/bestmovies">Mejor del momento</router-link> |
      <router-link to="/extramovies">Algo mas</router-link> |
    </div>-->
    <router-view />
  </div>
</template>
